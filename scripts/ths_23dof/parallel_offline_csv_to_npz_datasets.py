...
# Pre-defined configs
##
from whole_body_tracking.robots.ths_t1 import THS_T1_CYLINDER_CFG
...
class ReplayMotionsSceneCfg(InteractiveSceneCfg):
    ...
    # articulation
    robot: ArticulationCfg = THS_T1_CYLINDER_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
