...
.. code-block:: bash
    ...
    python ths_t1/offline_csv_to_npz.py --input_file data/fall_recovery.csv --input_fps 1 --frame_range 1 3 \
    --output_file ./motions/fall_recovery.npz --output_fps 10 --headless
