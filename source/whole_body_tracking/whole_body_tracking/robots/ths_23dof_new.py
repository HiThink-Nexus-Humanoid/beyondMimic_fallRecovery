...
THS_23DOF_CFG = ArticulationCfg(                                         
    ...
    actuators={                                                         
        "legs": ImplicitActuatorCfg(                            # 为腿部关节组创建隐式驱动器配置
            ...
            # 关节刚度系数
            stiffness={                                                 
                ".*_hip_pitch_joint":  150,                             # 俯仰关节                                    
                ".*_hip_roll_joint":   150,                             # 髋横滚关节
                ".*_hip_yaw_joint":    100,                              # 髋偏航关节
                ".*_knee_joint":       150,                             # 关节
        ...
        "feet": ImplicitActuatorCfg(                           # 为脚踝部关节组创建隐式驱动器配置
            ...
            # 关节刚度系数
            stiffness={                                                     
                ".*_ankle_pitch_joint":  50,                                # 脚踝俯仰关节
                ".*_ankle_roll_joint":   50,                                # 脚踝横滚关节
            },
            # 关节阻尼系数
            damping={                                                      
                ".*_ankle_pitch_joint":  3,                                 # 脚踝俯仰关节
                ".*_ankle_roll_joint":   3,                                # 脚踝横滚关节
            },
        ),
        ...
        "arms": ImplicitActuatorCfg(                               # 为手臂关节组创建隐式驱动器配置   
            ...
            # 关节刚度系数
            stiffness={                                                   
                ".*_shoulder_pitch_joint":  100,                             # 肩俯仰关节
                ".*_shoulder_roll_joint":   100,                             # 肩横滚关节
                ".*_shoulder_yaw_joint":    100,                             # 肩偏航关节
                ".*_elbow_joint":           100,                             # 肘俯仰关节
                ".*_wrist_roll_joint":      100,
            },
            # 关节阻尼系数
            damping={                                                     
                ".*_shoulder_pitch_joint":  7,                             # 肩俯仰关节 
                ".*_shoulder_roll_joint":   7,                             # 肩横滚关节   
                ".*_shoulder_yaw_joint":    7,                            # 肩偏航关节 
                ".*_elbow_joint":           7,                            # 肘俯仰关节
                ".*_wrist_roll_joint":      7,
            },
        ),
